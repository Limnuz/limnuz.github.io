...
function getLink(){
    ...
    visibleLink.innerHTML = `<b>Link: </b><a href="${link}" target="_blank"> --> CLICK HERE <-- </a>` + `<br> <small> If the link does not appear, <a href="${linkA}" target="_blank"> Click Here </a></small>`
}
